...
if __name__ == "__main__":
    ...
    if real_data_test:
        ...
        model_dir = os.path.join(TRAINED_MODELS, "vae_classifier/classifier_lr10")
        ...
        if synthetic_data_test:
            ...
            with torch.no_grad():
                ...
                out, z_mu, z_var = vae_classifier.forward(test_input_realistic, noise=False)
                print(out)
                ...
                out, z_mu, z_var = vae_classifier.forward(test_input_random, noise=False)
